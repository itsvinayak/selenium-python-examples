...
## selecting element
automation_button = driver.find_element_by_xpath(
    "//body[1]/div[1]/header[1]/nav[1]/div[1]/div[1]/div[2]/div[1]/a[2]"
)
...
## calling function to double click on automation button
action.double_click(automation_button)
