...
## selecting element
resources_button = driver.find_element_by_xpath(
    "//body[1]/div[1]/header[1]/nav[1]/div[1]/div[1]/div[2]/div[1]/div[1]/button[1]"
)
...
## calling function to click and hold resources button
action.click_and_hold(resources_button)
